...
# ==========================================
    ...
    # Se il player selezionato cambia, prova ad aggiornare D13 (gestendo l'eccezione se protetta)
    if str(selected_d13_val).strip().lower() != str(current_d13_val).strip().lower():
        try:
            ...
            # Se la cella è protetta, proseguiamo comunque aggiornando la vista locale
            pass
        st.rerun()
